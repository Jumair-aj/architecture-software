...
(async () => {
  ...
  const mainWindow = (0,_helpers__WEBPACK_IMPORTED_MODULE_3__.createWindow)('main', {
    ...
    // Use hiddenInset for custom color on macOS
    backgroundColor: '#000000',
    // Sets the frame color to black
    webPreferences: {
      preload: path__WEBPACK_IMPORTED_MODULE_0___default().join(__dirname, 'preload.js')
    },
    autoHideMenuBar: true,
    // This hides the menu bar
    icon: 'https://www.flaticon.com/free-icon/import_8816365'
  });
  if (isProd) {
